...
|---|---|---|
| [P2 Role-aware HIF and shared contracts](p2-role-aware-hif/) | exploring | A `roles` convention for HIF, validator and loaders, plus contracts C1, C2, C3, C5 for the programme |
