...
<!-- OWNER: the post is yours to publish (PLAN §5). Before publishing: fill in the three links; delete this comment.
     The numbers are from the survey re-run on exact counts from the 2026-09-22 dump (2026-09-25). About 380 words. -->
...
- Wikidata's qualifier schemas: the 1,155 properties that declare which qualifiers they allow, and the 13,315
  properties in use with the qualifiers actually observed on them, counted exactly over the Wikidata dump of
  2026-09-22.
...
- Wikidata's cyclic core has 391 to 1,458 relations. Its hypertree width is between 4 and 38 for the declared schema,
  and between 4 and 65 and between 3 and 53 for the observed ones. All 1,113 non-random queries in the HyperBench
