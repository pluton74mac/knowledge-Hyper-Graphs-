...
| [standards-convergence.md](standards-convergence.md) | survey | RDF 1.2 / SPARQL 1.2 (Concepts and Semantics at **Candidate Recommendation, 7 Apr 2026**; syntaxes and SPARQL still Working Drafts), ISO/IEC 39075:2024 **GQL** (published 12 Apr 2024, property graphs explicitly exclude n-ary relationships), **SQL/PGQ** (ISO/IEC 9075-16:2023), **HIF** (*Network Science* 13:e21, 2025 — the only natively higher-order standard) and **PG-Schema**. Concludes that the tracks converge on *annotation* and not on *arity*. |
