...
| [privacy-licensing-and-governance.md](privacy-licensing-and-governance.md) | The upstream licences (Freebase CC-BY, Wikidata CC0, Wikipedia CC BY-SA 3.0, LDC fee-based) and where the chain breaks in the derived benchmarks; the unarchived RAG-corpus problem; why n-ary facts amplify re-identification and resist erasure; Wikidata's living-people policy as prior art; Datasheets, Data Statements and AHORN as the frameworks to adopt. |
